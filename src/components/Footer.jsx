...
const Footer = async ({ params }) => {
    ...
    return (
        <section className='bg-black relative lg:px-28 lg:py-20 z-0 border-t-[1px] border-gray-700'>
            {/* Overlay */}
            ...
            <div className='relative z-20 block lg:flex items-center  gap-10  text-center lg:text-start'>
                ...
                <div className='lg:w-[40%]'>
                    <div className='py-10'>
                        <img alt='logo' className='w-52 m-auto lg:m-0' src={'/assets/logo-r.png'} />
                    </div>
                    {/* <p className="text-dark_gray text-lg ">{t(setting?.footer)}</p> */}

                    <div className='flex lg:gap-10 py-10 mx-10 lg:mx-0'>
                        {
                            iconsNavbar?.map((icon, index) => (
                                <div className='m-auto lg:m-0 ' key={index}>
                                    ...
                                    } className=' fill-white hover:fill-primary_Color_Meduim cursor-pointer'>{icon.icon}</Link>
                                </div>
                            ))
                        }
                    </div>
                ...
                <div className='lg:w-[20%] lg:py-10'>
                    <h3 className='text-white text-2xl font-semibold'>Contact Info</h3>
                    <div className='mt-5'>{
                        navbarLink.map((item, index) => (
                            <div className='my-4' key={index}>
                                <Link className='text-white  hover:text-primary_fill-primary_Color_Meduim text-lg' href={item.path}>{t(item.name)}</Link>
                            </div>
                        ))
                    }
                    </div>
                ...
                <div className='lg:w-[40%] py-10  '>
                    <div className='lg:flex gap-2 lg:items-start justify-start'>
                        <div className='flex gap-3 justify-center '>
                            <svg width={20} className=' mt-1 fill-primary_Color_Meduim' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512"><path d="M575.8 255.5c0 18-15 32.1-32 32.1l-32 0 .7 160.2c0 2.7-.2 5.4-.5 8.1l0 16.2c0 22.1-17.9 40-40 40l-16 0c-1.1 0-2.2 0-3.3-.1c-1.4 .1-2.8 .1-4.2 .1L416 512l-24 0c-22.1 0-40-17.9-40-40l0-24 0-64c0-17.7-14.3-32-32-32l-64 0c-17.7 0-32 14.3-32 32l0 64 0 24c0 22.1-17.9 40-40 40l-24 0-31.9 0c-1.5 0-3-.1-4.5-.2c-1.2 .1-2.4 .2-3.6 .2l-16 0c-22.1 0-40-17.9-40-40l0-112c0-.9 0-1.9 .1-2.8l0-69.7-32 0c-18 0-32-14-32-32.1c0-9 3-17 10-24L266.4 8c7-7 15-8 22-8s15 2 21 7L564.8 231.5c8 7 12 15 11 24z" /></svg>
                    ...
                    <div className='lg:flex gap-2 my-10 justify-center lg:justify-start'>
                        <div className='flex gap-3 justify-center '>
                            <svg width={18} className="fill-primary_Color_Meduim"
                    ...
                    <div className='lg:flex gap-2 items-start  justify-center lg:justify-start'>
                        ...
                        <div className='flex gap-3 justify-center '><svg
                            ...
                            width={18}
                            className=" mt-1 fill-primary_Color_Meduim"
                            viewBox="0 0 512 512"
                        >
