                ...
                <div className='lg:flex items-center ms-10 lg:mx-32 justify-between'>
                    ...
                    <div className='text-white text-[9px] lg:text-[13px]'>{path?.startsWith('/') && (
                        <div className='flex items-center gap-2'>
                            ...
                            <Link href={'/'} className='hover:text-primary_Color_Light'>Home</Link>
                                    ...
                                    .map((item, index) => {
                                        ...
                                        return isLast ? (
                                            <li key={index} className="flex items-center">
                                                ...
                                                <span className="text-white">{decodeURIComponent(item)}</span>
                                            </li>
                                        ) : (
                                            <li key={index} className="flex items-center">
                                                <Link href={href}>
                                                    <p className="text-white  ">
                                                        <span className='mx-2'>/</span>
                                                        <span className='hover:text-primary_Color_Meduim'> {decodeURIComponent(item)}</span>
                                                    </p>
                                                </Link>
                                            </li>
                                        );
